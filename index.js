...
const RatingViewIOS = NativeModules.RNRatingRequestor;
...
export default class RatingRequestor {
	...
	showRatingDialog(callback = () => {}) {
		const majorVersionIOS = parseFloat(Platform.Version);
		if (Platform.OS === 'ios' && majorVersionIOS >= 10.3) {
			RatingViewIOS.requestorRatingView();
			return;
		}
